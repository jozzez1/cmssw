...
void stPlots_Init(TFile* HistoFile, stPlots& st, std::string BaseName, unsigned int NCuts, bool SkipSelectionPlot=false, bool isSignal=true, unsigned int NCuts_Flip=0)
{
  ...
  ew TH2F(Name.c_str(), Name.c_str(),NCuts,0,NCuts,   20, 0,  1);  st.Beta_SelectedI   ->Sumw2();
  ...
  me = "BS_TNOHFraction" ; st.BS_TNOHFraction  = new TH1F(Name.c_str(), Name.c_str(),  50,  0,  1);                st.BS_TNOHFraction->Sumw2();
  ...
  Name = "BS_TNOMHTillLast" ; st.BS_TNOMHTillLast  = new TH1F(Name.F(Name.c_str(), Name.c_str(),  40,  0, 40);                st.BS_TNOM_PUB->Sumw2();
							      ...
							      Name = "BS_MPt"  ; st.BS_MPt   =str(),  25,  0, 100);               st.BS_TIsol->Sumw2();
  ...
  Name = "BS_LastHitDXY"    ; st.BS_LastHitDXY     = new TH1F(Name.c_str(), Name.c_str(),                   75, 0, 150); st.BS_LastHitDXY->SuUA->Sumw2();
  ...
  Name = "BS_Pt_DT"   ; st.BS_Pt_DT    = new TH1F(Name.c_str(), Name.c_str(),                   50, 0, PtHistoUpperBound); st.B      st.BS_Is_PUB->Sumw2();
  ...
  Name = "BS_Im_PUA"   ; st.BS_Im_PUA    = new TH1F(Name.c_str(), Name.c_str(),              , 5);                 st.BS_TOF_PUB->Sumw2();
  ...
  Name = "BS_dR_NVTrack"  ; st.BS_dR_NVTrack = new TH1F(Name.c_str(), Name.c_str(; st.BS_TimeAtIP->Sumw2();
										 ...
										 Name = "BS_NVertex";  st.BS_NVertex = new TH1F(Name.c_str(), Name.c_str(), 50, 0,  50);  st.BS_NVertex    ->S.BS_NOMoNOHvsPV->Sumw2();
										 ...
										 Name = "BS_dzMinv3d";   st.BS_dzMinv3d = new TH1F(Name.c_str(), Name.c_str(),200, -10, 10);       st.BS_dzMinv3d->Sumw2()w TH1F(Name.c_str(), Name.c_str(),                   50, -1., 1.); st.BS_SegMinEtaSep_FailDz->Sumw2();
										 ...
										 Name = "BS_Dz_FailSep"; st.BS_Dz_FailSep   = new TH1F(Name.c_str(), Name.c_str(), 50,  -150,  150); st.BS_Dz_FailSep->Sumw2()SC->Sumw2();
										 ...
										 Name = "BS_Pt_FailDz_DT"; st.BS_Pt_FailDz_DT = new TH1F(Name.c_str(), Name.c_str(),  50, 0, PtHistoUpperBound); st.BS_Pt_FailDD),            50, 0, PtHistoUpperBound, 50, 0, PtHistoUpperBound);    st.genrecopT->Sumw2();
  ...
  if(!isSignal) {
    ...
    Name = "H_D"; st.H_D = new TH1D(Name.c_str(), Name.c_sH) ,NCuts,0,NCuts); st.H_G->Sumw2();
